...
async function run() {
  try {
    ...
    try {
      const fs = require('fs');
      fs.writeFileSync('MCP_Workflow_workflow_20251103_202009.exported.json', JSON.stringify({ exported_at: new Date().toISOString(), servers, steps: __MCP_export_results__ }, null, 2));
