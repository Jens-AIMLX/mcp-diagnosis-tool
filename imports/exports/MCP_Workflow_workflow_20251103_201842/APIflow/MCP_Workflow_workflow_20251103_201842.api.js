...
// Usage: node MCP_Workflow_workflow_20251103_201842.api.js http://localhost:3060
...
(async function(){
  ...
  try {
    ...
    fs.writeFileSync('MCP_Workflow_workflow_20251103_201842.exported.json', JSON.stringify(out, null, 2));
