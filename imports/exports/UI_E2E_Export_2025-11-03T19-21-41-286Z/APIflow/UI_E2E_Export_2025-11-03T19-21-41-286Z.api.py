...
# Usage: python MCP_Workflow_workflow_20251103_202141.api.py http://localhost:3060
...
for name, sid in list(sessions.items()):
    try:
        ...
        pass
try:
    with open('MCP_Workflow_workflow_20251103_202141.exported.json', 'w', encoding='utf-8') as f:
