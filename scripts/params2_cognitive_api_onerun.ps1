...
$BASELINE_IMG_NAME = "baseline_zertifikate_$TIMESTAMP.jpg"
$BASELINE_IMG = "$SCREENSHOT_DIR/$BASELINE_IMG_NAME"
$REPORT_NAME = "MCPDiagnosis_Report_dimensions_p2_$TIMESTAMP.md"
...
try {
  $r = Invoke-ToolReport -Spec $CVA -ToolName 'cognitive_visual_dimensions' -ToolArgs @{imagePath=$BASELINE_IMG} -Filename $REPORT_NAME
