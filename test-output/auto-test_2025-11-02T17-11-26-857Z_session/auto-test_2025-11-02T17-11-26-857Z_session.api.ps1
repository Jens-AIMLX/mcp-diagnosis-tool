# API replay PowerShell script for MCP Diagnosis Tool v 1.2.1.15
# Usage: powershell -File auto-test_2025-11-02T17-11-26-857Z_session.api.ps1 -BaseUrl http://localhost:3060
