# API replay PowerShell script for MCP Diagnosis Tool v 1.0.0
# Usage: powershell -File auto-test_2025-11-02T01-56-54-701Z_session.api.ps1 -BaseUrl http://localhost:3060
