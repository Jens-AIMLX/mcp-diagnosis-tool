...
(async function(){
  ...
  try {
    ...
    fs.writeFileSync('MCP_Workflow_Smoke_20251103_105829.exported.json', JSON.stringify(out, null, 2));
    ...
    console.log('SMOKE: wrote MCP_Workflow_Smoke_20251103_105829.exported.json');
